...
%%
clear all;
basepath = 'C:\Users\ZouOptics\Desktop\HVI code\MATLAB analysis\analysis in neuron\102613_pc532\'
subfolder = ''
WL = 561;%
...
space = kernel(peakloc-400:peakloc+5000); % choose the suitable kernel range of X axis
figure()
plot(space)
...
space = kernel(peakloc-500:peakloc+4000); % choose the suitable kernel range of X axis
figure()
plot(space)
